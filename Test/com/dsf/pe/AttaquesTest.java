...
public class AttaquesTest {
    Personnage guerrier = new Guerrier("Atila",100,50,30,20);
    Personnage rodeur = new Rodeur("Robin des Bois",100,20,50,30);
    Personnage mage = new Mage("Gandalf",100,25,25,50);
